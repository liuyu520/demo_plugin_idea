package com.kunlunsoft.webview;
...
public class Browser extends Region {
     ...
     *
     *******************************************************************************************/
    public Browser(JfxScriptStateProvider stateProvider, String url) {
...
//        String url = getURL(htmlFile);
    ...
    private void createContextMenu(String url) {
